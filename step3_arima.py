"""
step3_arima.py
Fit ARIMA model on stock data (without pmdarima).
Run: python step3_arima.py
"""
...
future_model = ARIMA(ts, order=ORDER)
...
}).to_csv("forecast_arima.csv", index=False)
print("Saved ARIMA forecast to forecast_arima.csv")
